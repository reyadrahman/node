...
declare module 'express' {
  ...
  declare export class Request extends http$IncomingMessage mixins RequestResponseBase {
    baseUrl: string;
    body: mixed;
  ...
  declare export class Response extends http$ClientRequest mixins RequestResponseBase {
    headersSent: boolean;
  ...
  declare class RouterT extends Route {
  ...
  declare class Application extends RouterT mixins events$EventEmitter {
    constructor(): void;
    locals: {[name: string]: mixed};
    mountpath: string;
  ...
  declare export default () => Application;
  declare export function Router(options?: RouterOptions): RouterT;
  // {
