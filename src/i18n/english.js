...
export default {
    errors: {
        ...
        [E.FORCE_SEND_FEEDS_GENERAL]: `Sorry, couldn't send feeds`,
    ...
    successes: {
        ...
        [S.FORCE_SEND_FEEDS]: `Feeds successfully sent`,
    },
    app: {
        pageTitle: 'Deepiks: open source chatbot platform',
    },
    header: {
    },
    accountButton: {
    ...
    home: {
    	hello: 'open source chatbot platform',
    	baseline: '',
    ...
    markdown_h : 'Markdown',
		markdown_t : 'Use markdown to make your bot more interactive and attractive',
        ai_h : 'Human In The Loop',
        ai_t : 'Make it possible for your bot to get help from a human when needed',
        pricing: 'Pricing',
        price_1: 'FREE',
        price_2: '',
        price_3: '',
